function varargout = ElementID_GUI_4(varargin)
% ELEMENTID_GUI_4 MATLAB code for ElementID_GUI_4.fig
%      ELEMENTID_GUI_4, by itself, creates a new ELEMENTID_GUI_4 or raises the existing
%      singleton*.
%
%      H = ELEMENTID_GUI_4 returns the handle to a new ELEMENTID_GUI_4 or the handle to
%      the existing singleton*.
%
%      ELEMENTID_GUI_4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ELEMENTID_GUI_4.M with the given input arguments.
%
%      ELEMENTID_GUI_4('Property','Value',...) creates a new ELEMENTID_GUI_4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ElementID_GUI_4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ElementID_GUI_4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ElementID_GUI_4

% Last Modified by GUIDE v2.5 12-Dec-2016 15:52:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @ElementID_GUI_4_OpeningFcn, ...
    'gui_OutputFcn',  @ElementID_GUI_4_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before ElementID_GUI_4 is made visible.
function ElementID_GUI_4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ElementID_GUI_4 (see VARARGIN)

% Choose default command line output for ElementID_GUI_4
...
% UIWAIT makes ElementID_GUI_4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ElementID_GUI_4_OutputFcn(hObject, eventdata, handles)
...
xyBlocks = handles.xyBoxLocs;
xyLOCs = handles.xyCounts;
templateMaster = handles.TotalAllMask;
templateLocs = handles.tempMask;

cd(saveLOC);
save(char(curFname),'outTable','xyBlocks','xyLOCs','templateMaster','templateLocs');
...
coloRS = 'rbgycmrbgycmrbgycmrbgycmrbgycm';
